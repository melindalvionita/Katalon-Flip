...
WebUI.verifyElementText(findTestObject('Object Repository/Home Page/Refund/h5_Uh oh'))

WebUI.click(findTestObject('Object Repository/Home Page/Refund/button_OK'))
