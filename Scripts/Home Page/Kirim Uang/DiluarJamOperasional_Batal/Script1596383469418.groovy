...
WebUI.verifyElementText(findTestObject('Object Repository/Home Page/Kirim Uang/b_Yakin ingin melanjutkan transaksi'))

WebUI.click(findTestObject('Object Repository/Home Page/Kirim Uang/a_BATAL'))
