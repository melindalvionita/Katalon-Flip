...
WebUI.selectOptionByValue(findTestObject('Object Repository/Home Page/Kirim Uang/select_-- Pilih Bank --MandiriBRIBNI  BNI S_783f60_1'), 
    'mandiri', true)

WebUI.setText(findTestObject('Object Repository/Home Page/Kirim Uang/input_Rekening pengirim tidak boleh sama de_388eb1'), 
    '123456789')
