...
WebUI.click(findTestObject('Object Repository/Home Page/Email_Verifikasi/button_KIRIM ULANG EMAIL'))

WebUI.verifyElementText(findTestObject('Object Repository/Home Page/Email_Verifikasi/div_Email berhasil dikirim ulang'))
