...
WebUI.setText(findTestObject('Page_Signup/input_Lengkapi data berikut dan akun flipmu_8735ea'), 'flip123@mailinator.com')
...
WebUI.setText(findTestObject('Page_Signup/input_NOMOR HANDPHONE_no_hp'), '08123456789')

WebUI.click(findTestObject('Page_Signup/button_DAFTAR'))

WebUI.verifyElementText(findTestObject('Object Repository/Daftar/div_ErrorPassword minimal 8 karakterNomor h_b0b530'))
