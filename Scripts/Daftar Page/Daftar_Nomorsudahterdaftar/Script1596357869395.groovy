...
WebUI.setText(findTestObject('Page_Signup/input_Lengkapi data berikut dan akun flipmu_8735ea'), 'flip001@mailinator.com')
...
WebUI.verifyElementText(findTestObject('Page_Signup/li_Nomor handphone sudah terdaftar Silakan _720068'))
